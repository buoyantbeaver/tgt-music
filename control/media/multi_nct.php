          ...
          <td valign="top" class="style_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="title_c">THÊM ALBUM TỪ NCT 10/2/2013</td>
                  </tr>
                </table>               </td>
              </tr>
            </table>
...
<tr><td class=title align=center>THÊM ALBUM NHACCUATUI BY KM MUSIC 10/2/2013</td></tr>
<tr>
...
if (!$_POST['submit']) {
	...
	$url_song = explode('<li class="clearfix">', $url);
	$total_linksx = count($url_song);
    $total_links = $total_linksx-1;
	$album_z = explode('<meta content="Nghe playlist ', $url);
	$album_z = explode(' do ca sĩ  - ', $album_z[1]);
	$singer_z = explode(' trình bày', $album_z[1]);
    $album_z = $album_z[0];
    $singer_z = $singer_z[0];
	$album_info = explode('<div class="about">', $url);
	$album_info = explode('</div>', $album_info[1]);
	$album_info = str_replace('NhacCuaTui.Com',"KM Music",$album_info[0]);
...
for ($i=1;$i<=$total_links;$i++) {
	$play_url = explode('<h4><a href="', $url_song[$i]);
