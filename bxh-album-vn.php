...
<title>Bảng Xếp Hạng Album Việt Nam Tháng <? echo date('m');?></title>
...
<div id="main">
 ...
 <div class="bxh_title a_vn_ _bottom"><span>BXH</span> Album Việt Nam</div>
 <div class="bxh_title_s">Bảng Xếp Hạng Tuần <span><? echo $up[0][3];?></span></div>
 <div class="bxh_list _delline">
                <?
				$arr_vn_ = $tgtdb->databasetgt(" album_id, album_name, album_singer, album_img, album_cat ","album"," album_cat LIKE '%,".IDCATVN.",%' AND album_type = 0 ORDER BY album_viewed_month DESC LIMIT 10");				
...
?>
        <div class="top_mp3">
            ...
            <div class="x_2">
            <p class="song"><a title="Nghe bài hát <?=$arr_album[$z][1]; ?>" href="<?=$album_url; ?>"><?=$arr_album[$z][1]; ?></a></p>
