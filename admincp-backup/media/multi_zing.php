...
<tr><td class=title align=center>Add album zing mp3</td></tr>
<tr>
...
if (!$_POST['submit']) {
	...
	$album_info = str_replace('Zing Mp3',"IPOS",$album_info[0]);
...
<tr>
	<td class=fr width=30%>
		<b>Add album</b>
		<br>Please complete the information</td>
	<td class=fr_2>
    <table>
    <tr>
   ...
   <tr> <td><font color="grenn">Singer (Album):</font></td><td><input name="new_singer_a" value="<?=$singer_z?>" size=50></td>
    </tr></table>
	</td>
</tr>
...
<tr>
	...
	<td class=fr width=30%><b>Category</b></td>
