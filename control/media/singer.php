...
if($mode == 'add') {
	if(isset($_POST['submit'])) {
		if($_POST['name'] == "") {
			...
			$singer			=	htmlchars(stripslashes(trim(urldecode($_POST['name']))));			// lay thong tin: FullName, NgaySinh, QuocGia, Profile			$singer_fullname		=	htmlchars(stripslashes(trim(urldecode($_POST['fullname']))));			$singer_ngaysinh		=	htmlchars(stripslashes(trim(urldecode($_POST['ngaysinh']))));			$singer_quocgia		=	htmlchars(stripslashes(trim(urldecode($_POST['quocgia']))));			$singer_cty		=	htmlchars(stripslashes(trim(urldecode($_POST['cty']))));			$singer_page		=	htmlchars(stripslashes(trim(urldecode($_POST['page']))));			//ket thuc lay thong tin
			...
			mysql_query("INSERT INTO tgt_nhac_singer (singer_name,singer_name_ascii,singer_img,singer_type,singer_fullname,singer_ngaysinh,singer_quocgia,singer_cty,singer_page,singer_info) 
						 VALUES ('".$singer."','".$singer_ascii."','".$img."','".$type."','".$singer_fullname."','".$singer_ngaysinh."','".$singer_quocgia."','".$singer_cty."','".$singer_page."','".$info."')");
