...
//$cache = new cache();
//if ( $cache->caching ) {
$song 		= $tgtdb->databasetgt(" m_title, m_singer, m_cat, m_img, m_url, m_viewed, m_lyric, m_kbs, m_sang_tac,  m_lyricLRCNCT, m_lyricLRC ","data"," m_id = '".$id_media."' ORDER BY m_id DESC ");
...
$song_url_karaoke = '';
$song_url_karaoke = url_link($song[0][0].'-'.$title,$id_media,'nghe-bai-hat-karaoke');
...
<h1><? echo un_htmlchars($song[0][0]);?> - <span class="singer_"><a href="<? echo $singer_url;?>" title="Bài hát của ca sĩ <? echo $title;?>"><? echo un_htmlchars($title);?></a></span></h1>
			...
			<!--nghe ca khuc bang APlayer HTML5 Karaoke-->
			...
			<?}?>
			<h4 align="center"><a href="<? echo $song_url;?>" title="">Nghe bài hát: <? echo un_htmlchars($song[0][0]);?> - bằng jwplayer 7.x</a></h4>
                    </div>
					<?=BANNER('play_mp3','633');?>
   ...
   <p>Your browser does not support HTML5 audio :(</p>
			...
			<div class="player">
					<object id="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="100%" height="84">
						<param name="movie" value="<? echo SITE_LINK; ?>tgt_file/playermp3.nct.11.0.3.swf" />
						...
						<param name="flashvars" value="file=<? echo SITE_LINK; ?>xml/nct/<? echo en_id($id_media);?>.xml&autostart=true&ads=http://api.nas.nct.vn/v2/ads">
						<embed id="player" wmode="transparent" allowscriptaccess="always" allowfullscreen="true" width="100%" height="316" src="<? echo SITE_LINK; ?>tgt_file/playermp3.nct.11.0.3.swf" flashvars="file=<? echo SITE_LINK; ?>xml/nct/<? echo en_id($id_media);?>.xml&autostart=true&ads=<? echo SITE_LINK; ?>tgt_file/QuangCao.swf" />
					</object>
			</div>
