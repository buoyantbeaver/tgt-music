...
include("./control/fckeditor/fckeditor.php");
...
<div class="row">
<div class="col-lg-12">
	<h1 class="page-header"><?echo audio;?></h1>
</div>
</div>
...
<span class="findasong">
<form class="form-group input-group" action="media.php">
...
<div class="table-responsive">
    ...
    <table class="table table-hover">
        ...
        <td nowrap class="menu" width="15"><font color="blue"><b>Type</b></font></td>
...
<? } ?>
        ...
        <input type="submit" name="do" class="btn btn-sm btn-primary" value="Apply">
		</div>
</div>
</body>
</html>
