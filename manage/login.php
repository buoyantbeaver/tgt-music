...
if(isset($_GET["act"]) && $_GET["act"] == "login"){
	...
	elseif ($arr[0][4] == 3) {
			...
			mss("Chào mừng ".$_SESSION["username"]." đến với Bảng điều khiển !","index.php");
			exit();
	}
	else {
...
<html>
<head>
<title>Đăng nhập Admin Cpanel Website</title>
...
<table width="300"  border="0" cellspacing="0" cellpadding="1" align="center">
  <tr>
    <td align="center"><strong>Đăng nhập Admin Cpanel</strong></td>
  </tr>
  <tr>
    <td><table width="100%" class="border" border="0" cellspacing="0" cellpadding="3" align="center"  >
        <form name="signin" method="post" action="login.php?act=login">
          ...
          <tr >
            <td align="right">Mật khẩu Admin</td>
            <td ><input type="password" name="pass2" value="" class="input"></td>
          </tr>
          <tr >
            <td></td>		  
            <td ><input type="submit" name="login" class="sutm" value=" ĐĂNG NHẬP "></td>
          </tr>
        </form>
      </table></td>
  </tr>
