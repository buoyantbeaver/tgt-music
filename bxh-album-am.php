...
<title>Bảng Xếp Hạng Album Âu Mỹ Tháng <? echo date('m');?></title>
...
<?
				$arr_vn_ = $tgtdb->databasetgt(" album_id, album_name, album_singer, album_img, album_cat ","album"," album_cat LIKE '%,".IDCATAM.",%' AND album_type = 0 ORDER BY album_viewed_month DESC LIMIT 40");				
