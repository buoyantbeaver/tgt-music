...
$arr = $tgtdb->databasetgt(" m_id, m_url, m_title, m_singer, m_is_local, m_lyricCaption ","data"," m_id = '".$id."'");

$xml .= str_replace("  ", " ", un_htmlchars($arr[0][5]));
...
if(strlen($xml)<5){
	...
	$xml .= SITE_LINK." Chúc các bạn 1 ngày zui vẻ !\n";
	$xml .= "\n";
	$xml .= "4\n";
	...
	$xml .= "<font color=\"#FFFF00\">Hãy ghé thăm website thường xuyên để được thưởng thức những tác phẩm hot nhé.</font>\n";
	$xml .= SITE_LINK." Chúc các bạn 1 ngày zui vẻ !\n";
 //' Trình bày: '.text_tidy(get_data("singer","singer_name"," singer_id = '".$arr[0][3]."'"));
}
