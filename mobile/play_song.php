...
//$cache = new cache();
//if ( $cache->caching ) {
$song 		= $tgtdb->databasetgt(" m_title, m_singer, m_cat, m_img, m_poster, m_viewed, m_lyric, m_kbs, m_sang_tac, m_is_local, m_url, m_lyricLRC, m_lyricLRCNCT","data"," m_id = '".$id_media."' ORDER BY m_id DESC ");
...
//Aplayer 
//Lay anh cua bai hat
$song_url_directLink = grab(get_url($song[0][9],$song[0][10]));
$song_image_directLink = $song[0][3];
$song_image_directLink = check_img($song_image_directLink);
$song_lyric_LRC = $song[0][11];
//Kiem tra xem co duong dan file .lrc NCT
$lyricLRCNCT = str_replace("'", " ", un_htmlchars($song[0][12]));
//end Aplayer
...
<script type='text/javascript' src="scripts/APlayer.min.js"></script>
</head>
    <body>
        <div class="header">
            <h1 class="logo">
