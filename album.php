...
<title><? echo $title_web;?> | album | playlist | Trang <? echo $page;?></title>
...
<div id="main">
    ...
    <div id="contents">
        ...
        <div id="m_2">
                    ...
                    switch($act){
                        default					:include("./playlist/vn.php");break;
                        case "Viet-Nam"			:include("./playlist/vn.php");break;
						case "Au-My"			:include("./playlist/am.php");break;
						case "Chau-A"			:include("./playlist/ca.php");break;
                    }
                    ?>
        </div>
        <!--3-->
