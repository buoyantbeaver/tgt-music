            <div class="box w_2">
                <div>
                    <div id="slider">
                        <ul>
                    <?
                    $hotA = $tgtdb->databasetgt("album_id, album_name, album_singer, album_img_big","album"," album_type = 0 AND album_hot = 1 ORDER BY album_id DESC LIMIT 4");
				...
				for($i=0;$i<count($hotA);$i++) { 
						...
						$album_singerA	=	rut_ngan(get_data("singer","singer_name"," singer_id = '".$hotA[$i][2]."'"),4);
				?>
