...
$As3karaokeSongInfo = str_replace("'", " ", un_htmlchars($song[0][0])).' - '.$title.','.$lyricKAR;
?>
...
<div class="player">
<embed id="player" wmode="transparent" allowscriptaccess="always" allowfullscreen="true" width="100%" height="410" src='<? echo SITE_LINK; ?>tgt_file/sampleplayer.swf?songList=<? echo $As3karaokeSongInfo; ?>&menu=true&scale=noScale&autoPlay=true&height=410' />
</div>
