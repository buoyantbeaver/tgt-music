          ...
          <td valign="top" class="style_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="title_c">Thêm Media từ Ca sĩ Zing MP3</td>
                  </tr>
                </table>               </td>
              </tr>
            </table>
...
<tr><td class=title align=center>Thêm Media từ Ca sĩ Zing MP3</td></tr>
<tr>
	<td class=fr width=10% align=center>
	<input name="total_songs" size=100 value="" style="text-align:center">
	<br><br>
+ Định dạng : http://mp3.zing.vn/tim-kiem/bai-hat.html?q=lam+chan+khang<br>
</td>
</tr>
...
if (!$_POST['submit']) {
	...
	$url_song = explode('<div class="content-item ie-fix', $url);
...
for ($i=1;$i<=$total_links;$i++) {
    ...
    $txt2='http://mp3.zing.vn/bai-hat/'.$play_url[0];
    $song = explode('<a title="', $url_song[$i]);
    $song = explode(' - ', $song[1]);
    $song = $song[0];
	$singer = explode('artist" title="Tìm bài hát của ', $url_song[$i]);
    $singer = explode('" class="txtBlue">', $singer[1]);
    $singer = $singer[0];
...
<?php
	...
	echo "<h3>Đã update thành công</h3><meta http-equiv='refresh' content='1;url=$link'>";
}
}
?>
                </td>
