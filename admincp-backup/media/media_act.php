...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width=100% align=center cellpadding="2" cellspacing="2">
		...
		<tr><td class=fr width=100px>Đường dẫn lời nhạc (LRC NCT)</td><td class=fr_2><input type=text name="lyricLRCNCT" size=80 value="<? echo $arrz[0][10];?>"></td></tr>
		<tr><td class=fr width=100px>Đường dẫn lời nhạc (SRT)</td><td class=fr_2><input type=text name="lyricSRT" size=100 value="<? echo $arrz[0][12];?>"></td></tr>
		<tr><td class=fr width=100px>Đường dẫn lời nhạc (LRC)</td><td class=fr_2><input type=text name="lyricLRC" size=100 value="<? echo $arrz[0][13];?>"></td></tr>
		<tr><td class=fr width=100px>Đường dẫn lời nhạc Karaoke(XML)</td><td class=fr_2><input type=text name="lyricKAR" size=100 value="<? echo $arrz[0][14];?>"></td></tr>
                <tr><td class=fr width=100px>Đường dẫn lời nhạc ZingStar Karaoke(XML)</td><td class=fr_2><input type=text name="lyricZSTAR" size=100 value="<? echo $arrz[0][15];?>"></td></tr>
...
<p>[ <? echo $arrz[0][5];?> ]</p>
		...
		<tr><td class=fr width=100px>Đường dẫn ảnh bài hát:</td><td class=fr_2><input type=text name="image" size=100 value="<? echo $arrz[0][5];?>"></td></tr>
		...
		<tr><td class=fr width=100px valign="top"><b>Lời nhạc động:</b> </td><td class=fr_2>
        <textarea style="height: 250px; width: 600px;" name="lyricCaption"><?=un_htmlchars($arrz[0][11]);?></textarea>
        </td></tr>
