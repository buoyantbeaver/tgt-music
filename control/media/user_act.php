...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width=100% align=center cellpadding="2" cellspacing="2">
		<tr><td class=fr width=100px>Tài khoản</td><td class=fr_2><input type=text name="name" size=50 value="<? echo $arrz[0][0];?>"></td></tr>
		<tr><td class=fr width=100px>Mật khẩu </td><td class=fr_2><input type=text name="pass" size=50 value=""></td></tr>
        <tr><td class=fr width=100px>Email </td><td class=fr_2><input type=text name="email" size=50 value="<? echo $arrz[0][1];?>"></td></tr>
		<tr><td class=fr width=100px>Phân quyền </td><td class=fr_2><?=acp_level($arrz[0][2]);?></td></tr>
        <tr><td colspan="2"><input type="submit" name="submit" value="ĐỒNG Ý"></td></tr>
	</table>
</form>
