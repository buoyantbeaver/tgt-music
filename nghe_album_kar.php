...
<div class="player">
	   <h4><font color="red">Lưu ý: Bài hát nào có lời nhạc .xml theo định dạng của AS3 Flash Karaoke mới được hiển thị ở danh sách.</font></h4>
	   <h4><font color="blue">Cảm ơn bạn đã nghe nhạc - Chúc bạn luôn luôn vui vẻ và hạnh phúc.</font></h4>
       <embed id="player" wmode="transparent" allowscriptaccess="always" allowfullscreen="true" width="100%" height="410" src='<? echo SITE_LINK; ?>tgt_file/sampleplayer.swf?songList=<? echo $songalbum; ?>&menu=true&scale=noScale&autoPlay=true' />
</div>
