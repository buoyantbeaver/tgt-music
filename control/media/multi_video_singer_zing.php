          ...
          <td valign="top" class="style_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="title_c">Thêm Video từ Ca sĩ trên Zing MP3</td>
                  </tr>
                </table>               </td>
              </tr>
            </table>
...
<tr><td class=title align=center>Thêm Video từ Ca sĩ trên Zing MP3</td></tr>
<tr>
	<td class=fr width=10% align=center>
	<input name="total_songs" size=100 value="" style="text-align:center">
	<br><br>
+ Định dạng : http://mp3.zing.vn/tim-kiem/video.html?q=lam+chan+khang<br>
</td>
</tr>
...
if (!$_POST['submit']) {
	...
	$url_song = explode('<div class="video-item', $url);
