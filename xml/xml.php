...
//lay link va kiem tra xem co phai link nct
$link_song_mp3 = str_replace("'", " ", un_htmlchars($arr[0][1]));
if (preg_match('/http\:\/\/(www\.)?nhaccuatui\.com\/bai-hat\/.*/', $link_song_mp3)) { 
        //return 'song'; 
		$link_song_mp3 = getMp3($link_song_mp3);
}else{
		$link_song_mp3 = grab(get_url($arr[0][4],$arr[0][1]));
}
//ket thuc kiem tra link bai-hat nct
...
$xml .= '<item>'.
		...
		'<jwplayer:source file="'.$link_song_mp3.'" type="audio/mpeg"/>'.
