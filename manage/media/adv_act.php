...
<td class=frz width=100px>Liên kết</td><td class=frz><input type=text name="link_banner" size=50 value="<?=$arrz[0][4];?>"></td></tr>
<tr><td colspan="2" height="1" bgcolor="#CCCCCC"></td></tr>
<tr><td class=frz width=100px>URL Ảnh</td><td class=frz><input type="text" name="file" size=50 value="<?=$arrz[0][3];?>"></td></tr>
<tr><td colspan="2" height="1" bgcolor="#CCCCCC"></td></tr>
...
<tr><td colspan="2" height="1" bgcolor="#CCCCCC"></td></tr>
<tr><td class=frz width=100px>Vị trí hiển thị </td><td class=frz>
<select name="vitri">
...
<tr><td colspan="2" height="1" bgcolor="#CCCCCC"></td></tr>
<tr><td class=frz width=100px>Trạng thái </td><td class=frz>
<select name="status">
	<option value="0"<? if($arrz[0][7]==0) echo ' selected';?>>Hiện</option>
    <option value="1"<? if($arrz[0][7]==1) echo ' selected';?>>Ẩn</option>
</select>
</td>
</tr>
<tr><td colspan="2" height="1" bgcolor="#CCCCCC"></td></tr>
