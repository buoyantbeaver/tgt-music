...
?><div class="panel panel-primary center-block" style="max-width:400px"><div class="panel-heading">	<h3 class="panel-title"><?echo howmanysongs;?></h3></div><div class="panel-body">
<form method=post><fieldset>	<div class="form-group">
	<input name="total_songs" pattern="[0-9]+" title="Please enter a number" size=10 class="form-control text-center center-block" style="max-width:200px">	</div>
    <div class="help-tip"><p><i>Vui lòng nhập số lượng Media được thêm</i></p></div>
	<input type="submit" name="ok"class="btn btn-primary center-block" value="<?echo submit;?>">
</fieldset></form></div></div><?php
}
else
{
...
<tr>
	...
	<td class=fr_2>
		<input name=new_singer size=50 class="form-control findasong">
		<select name=singer_type class="form-control findasong">
...
<tr>
	...
	<td class=fr_2>
		<input name=new_album size=50 class="form-control findasong">
	</td>
</tr>
<tr>
	<td class=fr width=30%>
